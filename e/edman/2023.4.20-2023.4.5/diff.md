# Comparing `tmp/edman-2023.4.20.tar.gz` & `tmp/edman-2023.4.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "edman-2023.4.20.tar", last modified: Thu Apr 20 03:06:14 2023, max compression
+gzip compressed data, was "edman-2023.4.5.tar", last modified: Wed Apr  5 05:03:14 2023, max compression
```

## Comparing `edman-2023.4.20.tar` & `edman-2023.4.5.tar`

### file list

```diff
@@ -1,30 +1,30 @@
-drwxr-xr-x   0 ohno      (1000) ohno      (1000)        0 2023-04-20 03:06:14.787900 edman-2023.4.20/
--rw-r--r--   0 ohno      (1000) ohno      (1000)     1115 2023-02-17 05:03:50.000000 edman-2023.4.20/LICENSE.txt
--rw-r--r--   0 ohno      (1000) ohno      (1000)       19 2022-04-13 07:00:02.000000 edman-2023.4.20/MANIFEST.in
--rw-r--r--   0 ohno      (1000) ohno      (1000)     6380 2023-04-20 03:06:14.787900 edman-2023.4.20/PKG-INFO
--rw-r--r--   0 ohno      (1000) ohno      (1000)     6049 2023-01-20 03:28:32.000000 edman-2023.4.20/README.rst
-drwxr-xr-x   0 ohno      (1000) ohno      (1000)        0 2023-04-20 03:06:14.787900 edman-2023.4.20/edman/
--rw-r--r--   0 ohno      (1000) ohno      (1000)      167 2022-04-13 07:00:02.000000 edman-2023.4.20/edman/__init__.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)     1373 2023-03-15 05:16:00.000000 edman-2023.4.20/edman/config.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    16457 2023-03-15 05:16:00.000000 edman-2023.4.20/edman/convert.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    47757 2023-04-05 05:00:36.000000 edman-2023.4.20/edman/db.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)      644 2022-04-13 07:00:02.000000 edman-2023.4.20/edman/exceptions.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    21510 2023-04-20 03:03:49.000000 edman-2023.4.20/edman/file.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)     1520 2023-03-09 05:51:32.000000 edman-2023.4.20/edman/json_manager.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)     9907 2023-04-10 07:58:11.000000 edman-2023.4.20/edman/search.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    10958 2023-03-09 05:51:32.000000 edman-2023.4.20/edman/utils.py
-drwxr-xr-x   0 ohno      (1000) ohno      (1000)        0 2023-04-20 03:06:14.787900 edman-2023.4.20/edman.egg-info/
--rw-r--r--   0 ohno      (1000) ohno      (1000)     6380 2023-04-20 03:06:14.000000 edman-2023.4.20/edman.egg-info/PKG-INFO
--rw-r--r--   0 ohno      (1000) ohno      (1000)      470 2023-04-20 03:06:14.000000 edman-2023.4.20/edman.egg-info/SOURCES.txt
--rw-r--r--   0 ohno      (1000) ohno      (1000)        1 2023-04-20 03:06:14.000000 edman-2023.4.20/edman.egg-info/dependency_links.txt
--rw-r--r--   0 ohno      (1000) ohno      (1000)       54 2023-04-20 03:06:14.000000 edman-2023.4.20/edman.egg-info/requires.txt
--rw-r--r--   0 ohno      (1000) ohno      (1000)        6 2023-04-20 03:06:14.000000 edman-2023.4.20/edman.egg-info/top_level.txt
--rw-r--r--   0 ohno      (1000) ohno      (1000)      708 2023-04-20 03:06:14.787900 edman-2023.4.20/setup.cfg
--rw-r--r--   0 ohno      (1000) ohno      (1000)       41 2022-04-13 07:00:02.000000 edman-2023.4.20/setup.py
-drwxr-xr-x   0 ohno      (1000) ohno      (1000)        0 2023-04-20 03:06:14.787900 edman-2023.4.20/tests/
--rw-r--r--   0 ohno      (1000) ohno      (1000)    12303 2022-04-13 07:00:02.000000 edman-2023.4.20/tests/test_convert.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    86854 2023-04-20 03:03:49.000000 edman-2023.4.20/tests/test_db.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    36814 2023-04-20 03:03:49.000000 edman-2023.4.20/tests/test_file.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)     5837 2023-03-09 05:51:32.000000 edman-2023.4.20/tests/test_multiuser.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)    19062 2023-04-05 05:00:36.000000 edman-2023.4.20/tests/test_search.py
--rw-r--r--   0 ohno      (1000) ohno      (1000)     7898 2022-04-13 07:00:02.000000 edman-2023.4.20/tests/test_utils.py
...
### Comparing `edman-2023.4.20/LICENSE.txt` & `edman-2023.4.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/PKG-INFO` & `edman-2023.4.5/PKG-INFO`
...
### Comparing `edman-2023.4.20/README.rst` & `edman-2023.4.5/README.rst`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/config.py` & `edman-2023.4.5/edman/config.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/convert.py` & `edman-2023.4.5/edman/convert.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/db.py` & `edman-2023.4.5/edman/db.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/exceptions.py` & `edman-2023.4.5/edman/exceptions.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/file.py` & `edman-2023.4.5/edman/file.py`
...
### Comparing `edman-2023.4.20/edman/json_manager.py` & `edman-2023.4.5/edman/json_manager.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman/search.py` & `edman-2023.4.5/edman/search.py`
...
### Comparing `edman-2023.4.20/edman/utils.py` & `edman-2023.4.5/edman/utils.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/edman.egg-info/PKG-INFO` & `edman-2023.4.5/edman.egg-info/PKG-INFO`
...
### Comparing `edman-2023.4.20/setup.cfg` & `edman-2023.4.5/setup.cfg`
...
### Comparing `edman-2023.4.20/tests/test_convert.py` & `edman-2023.4.5/tests/test_convert.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/tests/test_db.py` & `edman-2023.4.5/tests/test_db.py`
...
### Comparing `edman-2023.4.20/tests/test_file.py` & `edman-2023.4.5/tests/test_file.py`
...
### Comparing `edman-2023.4.20/tests/test_multiuser.py` & `edman-2023.4.5/tests/test_multiuser.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/tests/test_search.py` & `edman-2023.4.5/tests/test_search.py`

 * *Files identical despite different names*

### Comparing `edman-2023.4.20/tests/test_utils.py` & `edman-2023.4.5/tests/test_utils.py`

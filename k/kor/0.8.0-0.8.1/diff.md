# Comparing `tmp/kor-0.8.0.tar.gz` & `tmp/kor-0.8.1.tar.gz`
...
### Comparing `kor-0.8.0/kor/type_descriptors.py` & `kor-0.8.1/kor/type_descriptors.py`
...
### Comparing `kor-0.8.0/PKG-INFO` & `kor-0.8.1/PKG-INFO`

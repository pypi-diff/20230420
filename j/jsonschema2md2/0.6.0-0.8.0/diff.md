# Comparing `tmp/jsonschema2md2-0.6.0.tar.gz` & `tmp/jsonschema2md2-0.8.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jsonschema2md2-0.6.0.tar", max compression
+gzip compressed data, was "jsonschema2md2-0.8.0.tar", max compression
```

## Comparing `jsonschema2md2-0.6.0.tar` & `jsonschema2md2-0.8.0.tar`

### file list

```diff
@@ -1,6 +1,5 @@
--rw-r--r--   0        0        0    11357 2022-09-30 11:42:12.224194 jsonschema2md2-0.6.0/LICENSE
--rw-r--r--   0        0        0     2568 2022-09-30 11:42:12.224194 jsonschema2md2-0.6.0/README.md
--rw-r--r--   0        0        0    12599 2022-09-30 13:35:04.136221 jsonschema2md2-0.6.0/jsonschema2md2/__init__.py
--rw-r--r--   0        0        0     1189 2022-09-30 13:35:15.612259 jsonschema2md2-0.6.0/pyproject.toml
--rw-r--r--   0        0        0     3641 1970-01-01 00:00:00.000000 jsonschema2md2-0.6.0/setup.py
--rw-r--r--   0        0        0     3860 1970-01-01 00:00:00.000000 jsonschema2md2-0.6.0/PKG-INFO
...
### Comparing `jsonschema2md2-0.6.0/LICENSE` & `jsonschema2md2-0.8.0/LICENSE`

 * *Files identical despite different names*

### Comparing `jsonschema2md2-0.6.0/README.md` & `jsonschema2md2-0.8.0/README.md`
...
### Comparing `jsonschema2md2-0.6.0/jsonschema2md2/__init__.py` & `jsonschema2md2-0.8.0/jsonschema2md2/__init__.py`
...
### Comparing `jsonschema2md2-0.6.0/PKG-INFO` & `jsonschema2md2-0.8.0/PKG-INFO`
...
-Requires-Dist: importlib_metadata (>=1,<2); python_version < "3.8"

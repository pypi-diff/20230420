# Comparing `tmp/proteinTools-1.1.9.tar.gz` & `tmp/proteinTools-1.2.0.tar.gz`
...
## Comparing `proteinTools-1.1.9.tar` & `proteinTools-1.2.0.tar`
...
### Comparing `proteinTools-1.1.9/LICENSE` & `proteinTools-1.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `proteinTools-1.1.9/proteinTools/PT.py` & `proteinTools-1.2.0/proteinTools/PT.py`
...
### Comparing `proteinTools-1.1.9/setup.py` & `proteinTools-1.2.0/setup.py`

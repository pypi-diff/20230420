# Comparing `tmp/proteinTools-1.1.7.tar.gz` & `tmp/proteinTools-1.1.8.tar.gz`
...
## Comparing `proteinTools-1.1.7.tar` & `proteinTools-1.1.8.tar`
...
### Comparing `proteinTools-1.1.7/LICENSE` & `proteinTools-1.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `proteinTools-1.1.7/proteinTools/PT.py` & `proteinTools-1.1.8/proteinTools/PT.py`
...
### Comparing `proteinTools-1.1.7/setup.py` & `proteinTools-1.1.8/setup.py`

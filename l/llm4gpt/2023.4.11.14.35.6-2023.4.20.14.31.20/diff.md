# Comparing `tmp/llm4gpt-2023.4.11.14.35.6.tar.gz` & `tmp/llm4gpt-2023.4.20.14.31.20.tar.gz`
...
## Comparing `llm4gpt-2023.4.11.14.35.6.tar` & `llm4gpt-2023.4.20.14.31.20.tar`
...
### Comparing `llm4gpt-2023.4.11.14.35.6/.gitignore` & `llm4gpt-2023.4.20.14.31.20/.gitignore`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/.travis.yml` & `llm4gpt-2023.4.20.14.31.20/.travis.yml`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/CONTRIBUTING.rst` & `llm4gpt-2023.4.20.14.31.20/CONTRIBUTING.rst`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/LICENSE` & `llm4gpt-2023.4.20.14.31.20/LICENSE`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/Makefile` & `llm4gpt-2023.4.20.14.31.20/Makefile`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/PKG-INFO` & `llm4gpt-2023.4.20.14.31.20/PKG-INFO`
...
### Comparing `llm4gpt-2023.4.11.14.35.6/README.md` & `llm4gpt-2023.4.20.14.31.20/README.md`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/README.rst` & `llm4gpt-2023.4.20.14.31.20/README.rst`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/docs/Makefile` & `llm4gpt-2023.4.20.14.31.20/docs/Makefile`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/docs/conf.py` & `llm4gpt-2023.4.20.14.31.20/docs/conf.py`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/docs/installation.rst` & `llm4gpt-2023.4.20.14.31.20/docs/installation.rst`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/docs/make.bat` & `llm4gpt-2023.4.20.14.31.20/docs/make.bat`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/llm/clis/cli.py` & `llm4gpt-2023.4.20.14.31.20/llm/clis/cli.py`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/llm4gpt.egg-info/PKG-INFO` & `llm4gpt-2023.4.20.14.31.20/llm4gpt.egg-info/PKG-INFO`
...
### Comparing `llm4gpt-2023.4.11.14.35.6/setup.py` & `llm4gpt-2023.4.20.14.31.20/setup.py`

 * *Files identical despite different names*

### Comparing `llm4gpt-2023.4.11.14.35.6/tests/test_llm4gpt.py` & `llm4gpt-2023.4.20.14.31.20/tests/test_llm4gpt.py`

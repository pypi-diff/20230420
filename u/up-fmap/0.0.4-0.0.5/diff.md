# Comparing `tmp/up_fmap-0.0.4.tar.gz` & `tmp/up_fmap-0.0.5.tar.gz`
...
## Comparing `up_fmap-0.0.4.tar` & `up_fmap-0.0.5.tar`
...
### Comparing `up_fmap-0.0.4/LICENSE` & `up_fmap-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `up_fmap-0.0.4/README.md` & `up_fmap-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `up_fmap-0.0.4/setup.py` & `up_fmap-0.0.5/setup.py`
...
### Comparing `up_fmap-0.0.4/test/test_up_fmap.py` & `up_fmap-0.0.5/test/test_up_fmap.py`

 * *Files identical despite different names*

### Comparing `up_fmap-0.0.4/up_fmap/fmap_planner.py` & `up_fmap-0.0.5/up_fmap/fmap_planner.py`

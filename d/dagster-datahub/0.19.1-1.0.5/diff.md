# Comparing `tmp/dagster-datahub-0.19.1.tar.gz` & `tmp/dagster-datahub-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dagster-datahub-0.19.1.tar", last modified: Thu Apr 20 21:15:50 2023, max compression
+gzip compressed data, was "dagster-datahub-1.0.5.tar", last modified: Fri Aug 26 13:47:00 2022, max compression
```

## Comparing `dagster-datahub-0.19.1.tar` & `dagster-datahub-1.0.5.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-20 21:15:50.766227 dagster-datahub-0.19.1/
--rw-r--r--   0 root         (0) root         (0)    11344 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/LICENSE
--rw-r--r--   0 root         (0) root         (0)      214 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/MANIFEST.in
--rw-r--r--   0 root         (0) root         (0)      703 2023-04-20 21:15:50.766227 dagster-datahub-0.19.1/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      131 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-20 21:15:50.766227 dagster-datahub-0.19.1/dagster_datahub/
--rw-r--r--   0 root         (0) root         (0)      286 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/dagster_datahub/__init__.py
--rw-r--r--   0 root         (0) root         (0)        0 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/dagster_datahub/py.typed
--rw-r--r--   0 root         (0) root         (0)     3807 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/dagster_datahub/resources.py
--rw-r--r--   0 root         (0) root         (0)       23 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/dagster_datahub/version.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-20 21:15:50.766227 dagster-datahub-0.19.1/dagster_datahub.egg-info/
--rw-r--r--   0 root         (0) root         (0)      703 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      389 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/not-zip-safe
--rw-r--r--   0 root         (0) root         (0)       85 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       16 2023-04-20 21:15:50.000000 dagster-datahub-0.19.1/dagster_datahub.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)      162 2023-04-20 21:15:50.766227 dagster-datahub-0.19.1/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     1474 2023-04-20 21:07:09.000000 dagster-datahub-0.19.1/setup.py
...
### Comparing `dagster-datahub-0.19.1/LICENSE` & `dagster-datahub-1.0.5/LICENSE`
...
### Comparing `dagster-datahub-0.19.1/PKG-INFO` & `dagster-datahub-1.0.5/PKG-INFO`
...
### Comparing `dagster-datahub-0.19.1/dagster_datahub/resources.py` & `dagster-datahub-1.0.5/dagster_datahub/resources.py`
...
### Comparing `dagster-datahub-0.19.1/dagster_datahub.egg-info/PKG-INFO` & `dagster-datahub-1.0.5/dagster_datahub.egg-info/PKG-INFO`
...
### Comparing `dagster-datahub-0.19.1/setup.py` & `dagster-datahub-1.0.5/setup.py`

# Comparing `tmp/requirements_detector-1.1.0.tar.gz` & `tmp/requirements_detector-1.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "requirements_detector-1.1.0.tar", max compression
+gzip compressed data, was "requirements_detector-1.2.0.tar", max compression
```

## Comparing `requirements_detector-1.1.0.tar` & `requirements_detector-1.2.0.tar`

### file list

```diff
@@ -1,13 +1,22 @@
--rw-r--r--   0        0        0     1040 2022-03-19 11:44:46.946135 requirements_detector-1.1.0/LICENSE
--rw-r--r--   0        0        0     2577 2023-02-16 05:08:33.143003 requirements_detector-1.1.0/README.md
--rw-r--r--   0        0        0     1431 2023-02-16 05:09:39.518867 requirements_detector-1.1.0/pyproject.toml
--rw-r--r--   0        0        0      269 2023-02-15 08:01:47.968235 requirements_detector-1.1.0/requirements_detector/__init__.py
--rw-r--r--   0        0        0       59 2023-02-15 07:58:21.737143 requirements_detector-1.1.0/requirements_detector/__main__.py
--rw-r--r--   0        0        0     5872 2023-02-16 04:54:57.543601 requirements_detector-1.1.0/requirements_detector/detect.py
--rw-r--r--   0        0        0      103 2022-03-19 11:44:46.950136 requirements_detector-1.1.0/requirements_detector/exceptions.py
--rw-r--r--   0        0        0      340 2023-02-15 07:58:21.737143 requirements_detector-1.1.0/requirements_detector/formatters.py
--rw-r--r--   0        0        0     3999 2023-02-15 08:48:59.156933 requirements_detector-1.1.0/requirements_detector/handle_setup.py
--rw-r--r--   0        0        0     5548 2023-02-15 08:01:47.968235 requirements_detector-1.1.0/requirements_detector/requirement.py
--rw-r--r--   0        0        0      861 2023-02-15 07:58:21.737143 requirements_detector-1.1.0/requirements_detector/run.py
--rw-r--r--   0        0        0     3561 1970-01-01 00:00:00.000000 requirements_detector-1.1.0/setup.py
--rw-r--r--   0        0        0     3945 1970-01-01 00:00:00.000000 requirements_detector-1.1.0/PKG-INFO
...
### Comparing `requirements_detector-1.1.0/LICENSE` & `requirements_detector-1.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `requirements_detector-1.1.0/README.md` & `requirements_detector-1.2.0/README.md`

 * *Files identical despite different names*

### Comparing `requirements_detector-1.1.0/pyproject.toml` & `requirements_detector-1.2.0/pyproject.toml`
...
### Comparing `requirements_detector-1.1.0/requirements_detector/detect.py` & `requirements_detector-1.2.0/requirements_detector/detect.py`
...
### Comparing `requirements_detector-1.1.0/requirements_detector/handle_setup.py` & `requirements_detector-1.2.0/requirements_detector/handle_setup.py`

 * *Files identical despite different names*

### Comparing `requirements_detector-1.1.0/requirements_detector/requirement.py` & `requirements_detector-1.2.0/requirements_detector/requirement.py`

 * *Files identical despite different names*

### Comparing `requirements_detector-1.1.0/requirements_detector/run.py` & `requirements_detector-1.2.0/requirements_detector/run.py`

 * *Files identical despite different names*

### Comparing `requirements_detector-1.1.0/setup.py` & `requirements_detector-1.2.0/setup.py`
...
### Comparing `requirements_detector-1.1.0/PKG-INFO` & `requirements_detector-1.2.0/PKG-INFO`
...
-Requires-Dist: poetry-semver (>=0.1.0,<0.2.0)

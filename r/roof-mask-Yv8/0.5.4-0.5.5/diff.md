# Comparing `tmp/roof_mask_Yv8-0.5.4.tar.gz` & `tmp/roof_mask_Yv8-0.5.5.tar.gz`
...
### Comparing `roof_mask_Yv8-0.5.4/detectron2/checkpoint/c2_model_loading.py` & `roof_mask_Yv8-0.5.5/detectron2/checkpoint/c2_model_loading.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/checkpoint/catalog.py` & `roof_mask_Yv8-0.5.5/detectron2/checkpoint/catalog.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/checkpoint/detection_checkpoint.py` & `roof_mask_Yv8-0.5.5/detectron2/checkpoint/detection_checkpoint.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/config/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/compat.py` & `roof_mask_Yv8-0.5.5/detectron2/config/compat.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/config.py` & `roof_mask_Yv8-0.5.5/detectron2/config/config.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/defaults.py` & `roof_mask_Yv8-0.5.5/detectron2/config/defaults.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/instantiate.py` & `roof_mask_Yv8-0.5.5/detectron2/config/instantiate.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/config/lazy.py` & `roof_mask_Yv8-0.5.5/detectron2/config/lazy.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/data/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/benchmark.py` & `roof_mask_Yv8-0.5.5/detectron2/data/benchmark.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/build.py` & `roof_mask_Yv8-0.5.5/detectron2/data/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/catalog.py` & `roof_mask_Yv8-0.5.5/detectron2/data/catalog.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/common.py` & `roof_mask_Yv8-0.5.5/detectron2/data/common.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/dataset_mapper.py` & `roof_mask_Yv8-0.5.5/detectron2/data/dataset_mapper.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/builtin.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/builtin.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/builtin_meta.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/builtin_meta.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/cityscapes.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/cityscapes.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/cityscapes_panoptic.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/cityscapes_panoptic.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/coco.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/coco.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/coco_panoptic.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/coco_panoptic.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/lvis.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/lvis.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/lvis_v0_5_categories.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/lvis_v0_5_categories.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/lvis_v1_categories.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/lvis_v1_categories.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/lvis_v1_category_image_count.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/lvis_v1_category_image_count.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/datasets/pascal_voc.py` & `roof_mask_Yv8-0.5.5/detectron2/data/datasets/pascal_voc.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/detection_utils.py` & `roof_mask_Yv8-0.5.5/detectron2/data/detection_utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/samplers/distributed_sampler.py` & `roof_mask_Yv8-0.5.5/detectron2/data/samplers/distributed_sampler.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/samplers/grouped_batch_sampler.py` & `roof_mask_Yv8-0.5.5/detectron2/data/samplers/grouped_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/transforms/augmentation.py` & `roof_mask_Yv8-0.5.5/detectron2/data/transforms/augmentation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/transforms/augmentation_impl.py` & `roof_mask_Yv8-0.5.5/detectron2/data/transforms/augmentation_impl.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/data/transforms/transform.py` & `roof_mask_Yv8-0.5.5/detectron2/data/transforms/transform.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/engine/defaults.py` & `roof_mask_Yv8-0.5.5/detectron2/engine/defaults.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/engine/hooks.py` & `roof_mask_Yv8-0.5.5/detectron2/engine/hooks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/engine/launch.py` & `roof_mask_Yv8-0.5.5/detectron2/engine/launch.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/engine/train_loop.py` & `roof_mask_Yv8-0.5.5/detectron2/engine/train_loop.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/cityscapes_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/cityscapes_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/coco_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/coco_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/evaluator.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/evaluator.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/fast_eval_api.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/fast_eval_api.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/lvis_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/lvis_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/panoptic_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/panoptic_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/pascal_voc_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/pascal_voc_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/rotated_coco_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/rotated_coco_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/sem_seg_evaluation.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/sem_seg_evaluation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/evaluation/testing.py` & `roof_mask_Yv8-0.5.5/detectron2/evaluation/testing.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/api.py` & `roof_mask_Yv8-0.5.5/detectron2/export/api.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/c10.py` & `roof_mask_Yv8-0.5.5/detectron2/export/c10.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/caffe2_export.py` & `roof_mask_Yv8-0.5.5/detectron2/export/caffe2_export.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/caffe2_inference.py` & `roof_mask_Yv8-0.5.5/detectron2/export/caffe2_inference.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/caffe2_modeling.py` & `roof_mask_Yv8-0.5.5/detectron2/export/caffe2_modeling.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/caffe2_patch.py` & `roof_mask_Yv8-0.5.5/detectron2/export/caffe2_patch.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/flatten.py` & `roof_mask_Yv8-0.5.5/detectron2/export/flatten.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/shared.py` & `roof_mask_Yv8-0.5.5/detectron2/export/shared.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/torchscript.py` & `roof_mask_Yv8-0.5.5/detectron2/export/torchscript.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/export/torchscript_patch.py` & `roof_mask_Yv8-0.5.5/detectron2/export/torchscript_patch.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/aspp.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/aspp.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/batch_norm.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/batch_norm.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/blocks.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/blocks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/deform_conv.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/deform_conv.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/losses.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/losses.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/mask_ops.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/mask_ops.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/nms.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/nms.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/roi_align.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/roi_align.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/roi_align_rotated.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/roi_align_rotated.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/rotated_boxes.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/rotated_boxes.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/shape_spec.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/shape_spec.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/layers/wrappers.py` & `roof_mask_Yv8-0.5.5/detectron2/layers/wrappers.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/anchor_generator.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/anchor_generator.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/backbone/backbone.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/backbone/backbone.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/backbone/build.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/backbone/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/backbone/fpn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/backbone/fpn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/backbone/regnet.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/backbone/regnet.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/backbone/resnet.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/backbone/resnet.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/box_regression.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/box_regression.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/matcher.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/matcher.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/build.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/dense_detector.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/dense_detector.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/fcos.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/fcos.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/panoptic_fpn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/panoptic_fpn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/rcnn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/rcnn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/retinanet.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/retinanet.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/meta_arch/semantic_seg.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/meta_arch/semantic_seg.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/mmdet_wrapper.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/mmdet_wrapper.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/poolers.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/poolers.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/postprocessing.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/postprocessing.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/proposal_generator/build.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/proposal_generator/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/proposal_generator/proposal_utils.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/proposal_generator/proposal_utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/proposal_generator/rpn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/proposal_generator/rpn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/proposal_generator/rrpn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/proposal_generator/rrpn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/box_head.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/box_head.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/cascade_rcnn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/cascade_rcnn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/fast_rcnn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/fast_rcnn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/keypoint_head.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/keypoint_head.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/mask_head.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/mask_head.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/roi_heads.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/roi_heads.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/roi_heads/rotated_fast_rcnn.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/roi_heads/rotated_fast_rcnn.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/sampling.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/sampling.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/modeling/test_time_augmentation.py` & `roof_mask_Yv8-0.5.5/detectron2/modeling/test_time_augmentation.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/solver/build.py` & `roof_mask_Yv8-0.5.5/detectron2/solver/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/solver/lr_scheduler.py` & `roof_mask_Yv8-0.5.5/detectron2/solver/lr_scheduler.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/boxes.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/boxes.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/image_list.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/image_list.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/instances.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/instances.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/keypoints.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/keypoints.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/masks.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/masks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/structures/rotated_boxes.py` & `roof_mask_Yv8-0.5.5/detectron2/structures/rotated_boxes.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/__init__.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/base_tracker.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/base_tracker.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/bbox_iou_tracker.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/bbox_iou_tracker.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/hungarian_tracker.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/hungarian_tracker.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/iou_weighted_hungarian_bbox_iou_tracker.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/iou_weighted_hungarian_bbox_iou_tracker.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/utils.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/tracking/vanilla_hungarian_bbox_iou_tracker.py` & `roof_mask_Yv8-0.5.5/detectron2/tracking/vanilla_hungarian_bbox_iou_tracker.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/analysis.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/analysis.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/collect_env.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/collect_env.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/colormap.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/colormap.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/comm.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/comm.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/develop.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/develop.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/env.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/env.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/events.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/events.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/file_io.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/file_io.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/logger.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/logger.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/memory.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/memory.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/registry.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/registry.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/serialize.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/serialize.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/testing.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/testing.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/video_visualizer.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/video_visualizer.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/visualizer.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/visualizer.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/detectron2/utils/visualizer_new.py` & `roof_mask_Yv8-0.5.5/detectron2/utils/visualizer_new.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/roof_mask_Yv8.egg-info/SOURCES.txt` & `roof_mask_Yv8-0.5.5/roof_mask_Yv8.egg-info/SOURCES.txt`
...
### Comparing `roof_mask_Yv8-0.5.4/setup.py` & `roof_mask_Yv8-0.5.5/setup.py`
...
### Comparing `roof_mask_Yv8-0.5.4/tests/test.py` & `roof_mask_Yv8-0.5.5/tests/test.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/hub/__init__.py` & `roof_mask_Yv8-0.5.5/ultralytics/hub/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/hub/auth.py` & `roof_mask_Yv8-0.5.5/ultralytics/hub/auth.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/hub/session.py` & `roof_mask_Yv8-0.5.5/ultralytics/hub/session.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/hub/utils.py` & `roof_mask_Yv8-0.5.5/ultralytics/hub/utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/nn/autobackend.py` & `roof_mask_Yv8-0.5.5/ultralytics/nn/autobackend.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/nn/autoshape.py` & `roof_mask_Yv8-0.5.5/ultralytics/nn/autoshape.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/nn/modules.py` & `roof_mask_Yv8-0.5.5/ultralytics/nn/modules.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/nn/tasks.py` & `roof_mask_Yv8-0.5.5/ultralytics/nn/tasks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/cfg/__init__.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/cfg/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/augment.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/augment.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/base.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/base.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/build.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/build.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/dataloaders/stream_loaders.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/dataloaders/stream_loaders.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/dataloaders/v5augmentations.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/dataloaders/v5augmentations.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/dataloaders/v5loader.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/dataloaders/v5loader.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/dataset.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/dataset.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/dataset_wrappers.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/dataset_wrappers.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/data/utils.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/data/utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/exporter.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/exporter.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/model.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/model.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/predictor.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/predictor.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/results.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/results.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/trainer.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/trainer.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/engine/validator.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/engine/validator.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/__init__.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/autobatch.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/autobatch.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/benchmarks.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/benchmarks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/base.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/base.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/clearml.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/clearml.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/comet.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/comet.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/hub.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/hub.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/mlflow.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/mlflow.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/tensorboard.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/tensorboard.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/callbacks/wb.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/callbacks/wb.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/checks.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/checks.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/dist.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/dist.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/downloads.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/downloads.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/files.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/files.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/instance.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/instance.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/loss.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/loss.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/metrics.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/metrics.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/ops.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/ops.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/plotting.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/plotting.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/tal.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/tal.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/torch_utils.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/torch_utils.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/utils/tuner.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/utils/tuner.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/classify/predict.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/classify/predict.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/classify/train.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/classify/train.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/classify/val.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/classify/val.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/detect/predict.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/detect/predict.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/detect/train.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/detect/train.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/detect/val.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/detect/val.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/pose/predict.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/pose/predict.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/pose/train.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/pose/train.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/pose/val.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/pose/val.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/segment/predict.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/segment/predict.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/segment/train.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/segment/train.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/ultralytics/yolo/v8/segment/val.py` & `roof_mask_Yv8-0.5.5/ultralytics/yolo/v8/segment/val.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/yolo_roof/detect_functions.py` & `roof_mask_Yv8-0.5.5/yolo_roof/detect_functions.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/yolo_roof/geo_functions.py` & `roof_mask_Yv8-0.5.5/yolo_roof/geo_functions.py`

 * *Files identical despite different names*

### Comparing `roof_mask_Yv8-0.5.4/yolo_roof/report_functions.py` & `roof_mask_Yv8-0.5.5/yolo_roof/report_functions.py`

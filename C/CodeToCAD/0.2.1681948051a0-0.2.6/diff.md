# Comparing `tmp/CodeToCAD-0.2.1681948051a0.tar.gz` & `tmp/CodeToCAD-0.2.6.tar.gz`
...
### Comparing `CodeToCAD-0.2.1681948051a0/CodeToCAD/TestCodeToCADProvider.py` & `CodeToCAD-0.2.6/CodeToCAD/TestCodeToCADProvider.py`
